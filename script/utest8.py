...
if __name__ == "__main__":
    ...
    #------------------------------------------
        ...
        t3_file_list = get_file_names(protected_disk_path)
        print("--- 睡眠30秒继续执行 ---")
        time.sleep(30)
        t3 = get_current_utc_seconds()
        print("t3:", t3)
        time.sleep(2)
        ...
        print("--- 恢复到t3 ---")
        run_program([cdp_tool, "recover", protected_disk_guid, password, str(t3)])
        ...
        print("--- 检查文件列表 ---")
        t3_file_list_recover = get_file_names(protected_disk_path)
        if t3_file_list == t3_file_list_recover:
            print("两个列表完全相同")
        else:
            print("两个列表不同")
            print("before:", t3_file_list)
            print("after:", t3_file_list_recover)
