...
#define IOCTL_QH_END_RECOVERY   CTL_CODE(QH_IOCTL_TYPE, 0x809, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct _QH_RECOVERY_END_REQUEST
{
	GUID SourceVolumeGuid;
} QH_RECOVERY_END_REQUEST, *PQH_RECOVERY_END_REQUEST;
