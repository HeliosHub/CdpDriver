...
| 2 | `QH_PHASE_RECOVERY` | 一次性同步回填过程中的临时状态 |
...
| `IOCTL_QH_BEGIN_RECOVERY` | 准备 Recovery 历史视图并保持 Recovery Phase |
| `IOCTL_QH_COMMIT_RECOVERY` | 同步回填已准备的历史视图，成功后回到 Normal |
| `IOCTL_QH_CANCEL_RECOVERY` | 取消已准备的 Recovery，不回填 |
